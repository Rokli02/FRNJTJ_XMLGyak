...
public class xPathFRNJTJ {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String expression = getExpression(8);
	...
	private static String getExpression(int number) {
		...
		case 9: return "";	//	9) Válassza ki az összes student elemet, amely rendelkezik legalább egy bármilyen attribútummal.
		case 10: return "";	//	10) Válassza ki a dokumentum összes elemét.
		case 11: return "";	//	11) Válassza ki a class elem összes student elemét, amelynél a kor>20.
		case 12: return "";	//	12) Válassza ki az összes student elem összes keresztnev és vezeteknev csommópontot.
